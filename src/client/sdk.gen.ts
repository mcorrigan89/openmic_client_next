...
import type { CreateArtistData, CreateArtistResponse, CreateArtistError, DeleteArtistData, DeleteArtistResponse, DeleteArtistError, GetArtistData, GetArtistResponse, GetArtistError, UpdateArtistData, UpdateArtistResponse, UpdateArtistError, GetAllArtistsData, GetAllArtistsResponse, GetAllArtistsError, GetArtistsByTitleData, GetArtistsByTitleResponse, GetArtistsByTitleError, CreateEventData, CreateEventResponse, CreateEventError, GetCurrentEventData, GetCurrentEventResponse, GetCurrentEventError, AddArtistToEventData, AddArtistToEventResponse, AddArtistToEventError, SetNowPlayingData, SetNowPlayingResponse, SetNowPlayingError, RemoveArtistFromEventData, RemoveArtistFromEventResponse, RemoveArtistFromEventError, SetSortOrderData, SetSortOrderResponse, SetSortOrderError, DeleteTimeslotMarkerData, DeleteTimeslotMarkerResponse, DeleteTimeslotMarkerError, SetTimeslotMarkerData, SetTimeslotMarkerResponse, SetTimeslotMarkerError, UpdateTimeslotData, UpdateTimeslotResponse, UpdateTimeslotError, DeleteEventData, DeleteEventResponse, DeleteEventError, GetEventData, GetEventResponse, GetEventError, UpdateEventData, UpdateEventResponse, UpdateEventError, GetEventsData, GetEventsResponse, GetEventsError, SseData, SseResponse, SseError, CreateUserData, CreateUserResponse, CreateUserError, GetUserEmailData, GetUserEmailResponse, GetUserEmailError, GetUserData, GetUserResponse, GetUserError, UpdateUserData, UpdateUserResponse, UpdateUserError } from './types.gen';
 ...
 * Delete Artist
 */
export const deleteArtist = <ThrowOnError extends boolean = false>(options: Options<DeleteArtistData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).delete<DeleteArtistResponse, DeleteArtistError, ThrowOnError>({
        url: '/artist/{id}',
        ...options
    });
};
 ...
 * Update Artist
 */
export const updateArtist = <ThrowOnError extends boolean = false>(options: Options<UpdateArtistData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).put<UpdateArtistResponse, UpdateArtistError, ThrowOnError>({
        url: '/artist/{id}',
        ...options,
        headers: {
            'Content-Type': 'application/json',
 ...
 * Set Now Playing
 */
export const setNowPlaying = <ThrowOnError extends boolean = false>(options: Options<SetNowPlayingData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).put<SetNowPlayingResponse, SetNowPlayingError, ThrowOnError>({
 ...
 * Delete Timeslot
 */
export const deleteTimeslotMarker = <ThrowOnError extends boolean = false>(options: Options<DeleteTimeslotMarkerData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).delete<DeleteTimeslotMarkerResponse, DeleteTimeslotMarkerError, ThrowOnError>({
 ...
 * Set Timeslot
 */
export const setTimeslotMarker = <ThrowOnError extends boolean = false>(options: Options<SetTimeslotMarkerData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<SetTimeslotMarkerResponse, SetTimeslotMarkerError, ThrowOnError>({
        url: '/event/{event_id}/timeslot/marker',
        ...options,
        headers: {
            'Content-Type': 'application/json',
 ...
 * Update Timeslot
 */
export const updateTimeslot = <ThrowOnError extends boolean = false>(options: Options<UpdateTimeslotData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).put<UpdateTimeslotResponse, UpdateTimeslotError, ThrowOnError>({
