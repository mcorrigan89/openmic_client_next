...
export const deleteTimeslotMutation = (options?: Partial<Options<DeleteTimeslotData>>) => {
    const mutationOptions: UseMutationOptions<DeleteTimeslotResponse, DeleteTimeslotError, Options<DeleteTimeslotData>> = {
        mutationFn: async (localOptions) => {
...
export const setTimeslotQueryKey = (options: Options<SetTimeslotData>) => createQueryKey('setTimeslot', options);

export const setTimeslotOptions = (options: Options<SetTimeslotData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
        ...
        queryKey: setTimeslotQueryKey(options)
    });
};

export const setTimeslotMutation = (options?: Partial<Options<SetTimeslotData>>) => {
    const mutationOptions: UseMutationOptions<SetTimeslotResponse, SetTimeslotError, Options<SetTimeslotData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await setTimeslot({
                ...options,
                ...localOptions,
